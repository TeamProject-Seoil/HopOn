...
| 관리자 프론트엔드 | 🌐 **HopOn_ADMIN_Page (Vue 3)** | [![Repo](https://img.shields.io/badge/GitHub-HopOn__AdminPage-181717?logo=github)](https://github.com/TeamProject-Seoil/HopOn_ADMIN_Page) |
...
| 관리자 백엔드 | ⚙️ **HopOn_ADMIN (Spring Boot)** | [![Repo](https://img.shields.io/badge/GitHub-HopOn__Backend-181717?logo=github)](https://github.com/TeamProject-Seoil/HopOn_ADMIN) |
...
| 이름 | 역할 | 담당 | 내용 | 
|------|------|------|
| **조건희** | 팀장 | 프론트엔드 | 인프라·배포, API, SSE, 예약/운행 핵심 로직 |
| **김민재** | 팀원 | 프론트엔드 | 지도 UI, 예약/알림, Overlay/Marker |
| **유주현** | 팀원 | 프론트엔드 | 위치 업데이트, 운행 관리 UI |
| **최준영** | 팀원 | 백엔드 | Vue3 UI, 대시보드, 권한 관리 |
| **원동건** | 팀원 | 백엔드 | 디자인/문서 |
